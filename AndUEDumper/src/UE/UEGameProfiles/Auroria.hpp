...
class AuroriaProfile : public IGameProfile
{
public:
    ...
    {
        return {"com.herogame.gplay.outerland.auroria.survivalminecraft.mmorpg", "com.herogame.gplay.outerland.wandereruniverse", "com.xiaojiaogame.gplay.outerland.wandereruniverse"};
    }
